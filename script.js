document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFormSuccess(form) {
    ...
    successEl.textContent = form.getAttribute('data-success-text') || 'Thank you! Your message has been sent successfully.';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "LaunchPad Pro משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '1978b5b1-3abd-42fd-99d4-0fb26a67ec30',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '1978b5b1-3abd-42fd-99d4-0fb26a67ec30';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1978b5b1-3abd-42fd-99d4-0fb26a67ec30';
